                ...
                children: [
                  ...
                  Text(
                    ...
                    style: theme.textTheme.bodyLarge?.copyWith(
                        color: Color(0xFFa61818), fontWeight: FontWeight.bold),
                  ...
                  Expanded(
                    child: Text(
                      ...
                      style: theme.textTheme.bodyMedium
                          ?.copyWith(color: Color(0xFF464A4D)),
                      textAlign: TextAlign.center,
                    ),
                  ),
                  GestureDetector(
            ...
            return Column(
              ...
              children: [
                ...
                Text(
                  "Internet Connected",
                  style: theme.textTheme.bodyLarge?.copyWith(
                      color: Color(0xFF2BBD69), fontWeight: FontWeight.bold),
                  textAlign: TextAlign.center,
                ),
                const SizedBox(
                  height: 20,
