      ...
      body: Column(
        ...
        children: [
          ...
          Text(
            ...
            style: theme.textTheme.bodyLarge?.copyWith(color:Color(0xFFa61818), fontWeight: FontWeight.bold),
          ...
          Padding(
            ...
            child: Text(
              ...
              style: theme.textTheme.bodyMedium?.copyWith(color: Color(0xFF464A4D)),
              textAlign: TextAlign.center,
            ),
          ),
        ],
